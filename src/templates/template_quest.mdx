---
id: templatequest # The ID of the page should always be the same as the file name, just without the extension and any special characters
title: Template Rune # The title of the page should be the same as the ID, but should be capitalized and formatted like a proper title
...
slug: /template_rune # The slug of the page should be the same as the ID, but should be formatted like a URL with proper continuity & underscores
